...
from backend.routers import expenses, cameras, finance, clients, invoices, lenses, gallery
...
52: from backend.config import UPLOAD_DIR
53: app.mount("/uploads", StaticFiles(directory=UPLOAD_DIR), name="uploads")
